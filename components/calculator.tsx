...
export default function Calculator() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-[#3bafbe] dark:bg-gray-500">
      {/* Center the calculator within the screen */}
      <Card className="w-full max-w-md p-6 bg-[#80d5d8] dark:bg-gray-800 shadow-lg rounded-lg [box-shadow:0px_0px_0px_20px_black]">
        {/* Card header with title */}
        <CardHeader>
          <CardTitle className="text-2xl font-extrabold font-serif text-center text-black">
            Simple Calculator
          </CardTitle>
        </CardHeader>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="flex flex-col space-y-2 ">
              <Label htmlFor="num1"  className="text-black font-bold">Number 1</Label>
              <Input
                id="num1"
                type="number"
                value={num1}
            ...
            <div className="flex flex-col space-y-2">
              <Label htmlFor="num2" className="text-black font-bold">Number 2</Label>
              <Input
                id="num2"
                type="number"
                value={num2}
          ...
          {/* Display the result */}
          <div className="flex flex-col space-y-2">
            <Label htmlFor="result"  className="text-black font-bold">Result</Label>
            <Input
              id="result"
              type="text"
              value={result}
